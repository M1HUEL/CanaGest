...
/**
 * DTO que replica con exactitud la estructura de la entidad de dominio
 * ConteoInventarioGeneral. Utilizado para la transferencia de datos de las
 * sesiones globales de auditoría entre capas.
 *
 * @author ERICK
 */
public class ConteoInventarioDTO {
  ...
  /**
   * Constructor por defecto. Inicializa la lista interna para mitigar errores
   * de puntero nulo.
   */
  public ConteoInventarioDTO() {
    this.todosLosConteos = new ArrayList<>();
    this.verificadoGlobal = false; // Por defecto inicia sin verificar/aplicar definitivamente
  }

  /**
   * Constructor completo con todos los parámetros idénticos a la entidad de
   * dominio.
   */
  public ConteoInventarioDTO(String id, String codigoGeneral, String fechaRegistro, Boolean verificadoGlobal,
